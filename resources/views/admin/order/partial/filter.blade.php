<div class="btn-group order-order">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[shipping_method]" class="col-sm-2 control-label">
                                        {!! trans('order::order.label.shipping_method')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[shipping_method]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[payment_method]" class="col-sm-2 control-label">
                                        {!! trans('order::order.label.payment_method')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[payment_method]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[invoice_no]" class="col-sm-2 control-label">
                                        {!! trans('order::order.label.invoice_no')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[invoice_no]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[invoice_prefix]" class="col-sm-2 control-label">
                                        {!! trans('order::order.label.invoice_prefix')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[invoice_prefix]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[telephone]" class="col-sm-2 control-label">
                                        {!! trans('order::order.label.telephone')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[telephone]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ip]" class="col-sm-2 control-label">
                                        {!! trans('order::order.label.ip')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ip]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".order-order .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/order.order.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".order-order .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.order-order .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'order.order.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#order-order-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#order-order-list .btn-reset-filter').css('display', 'none');
