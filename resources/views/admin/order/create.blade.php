    ...
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                ...
                <button type="button" class="btn btn-default btn-sm" data-action='CLOSE' data-load-to='#order-order-entry' data-href='{{guard_url('order/order/0')}}'><i class="fa fa-times-circle"></i> {{ trans('app.close') }}</button>
            </div>
        </ul>
        <div class="tab-content clearfix">
            ...
            <div class="tab-pane active" id="details">
                ...
                @include('order::admin.order.partial.entry', ['mode' => 'create'])
            </div>
            {!! Form::close() !!}
        </div>
    </div>