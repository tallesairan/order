...
namespace Shopping\Order\Policies;
...
class OrderPolicy
{
    ...
    {
        if ($user->canDo('order.order.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('order.order.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('order.order.approve')) {
            return true;
        }
